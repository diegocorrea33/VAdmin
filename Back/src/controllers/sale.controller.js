...
import {
    getAll
} from '../services/sale/getAll';
import {
    getOne
} from '../services/sale/getOne';

import {
    getCreate
} from '../services/sale/getCreate';

import {
    getUpdate
} from '../services/sale/getUpdate';

import {
    getInfoBySale
} from '../services/sale/getInfoBySale'
...
export async function getInfoSale(req, res, next) {
    try {
        getInfoBySale(req.body)
            .then(data => {
                res.status(200).json({
                    message: data.message,
                    data: data.data,
